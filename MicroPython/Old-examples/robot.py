...
class Chassis:
    def __init__(self, motor_pins, speed):
        self.right_motor_control_1 = PWM(motor_pins[0], freq=10000)
        self.right_motor_control_2 = PWM(motor_pins[1], freq=10000)
        
        self.left_motor_control_1 = PWM(motor_pins[2], freq=10000)
        self.left_motor_control_2 = PWM(motor_pins[3], freq=10000)
                
        self.forw_motor_control_1 = PWM(motor_pins[4], freq=10000)
        self.forw_motor_control_2 = PWM(motor_pins[5], freq=10000)

        self.speed_r = speed[0]
        self.speed_l = speed[1]
        self.speed_f = speed[2]
        
    def low_stop(self):
        print('Low stop')
        self.right_motor_control_1.duty_u16(0)
        self.right_motor_control_2.duty_u16(0)
        self.left_motor_control_1.duty_u16(0)
        self.left_motor_control_2.duty_u16(0)
        self.forw_motor_control_1.duty_u16(0)
        self.forw_motor_control_2.duty_u16(0)
    
    def stop(self):
        print('Stop')
        self.right_motor_control_1.duty_u16(10000)
        self.right_motor_control_2.duty_u16(10000)
        self.left_motor_control_1.duty_u16(10000)
        self.left_motor_control_2.duty_u16(10000)
        self.forw_motor_control_1.duty_u16(10000)
        self.forw_motor_control_2.duty_u16(10000)
        
    def forward(self):
        print('Move forward')
        self.right_motor_control_1.duty_u16(self.speed_r)
        self.right_motor_control_2.duty_u16(0)
        self.left_motor_control_1.duty_u16(self.speed_l)
        self.left_motor_control_2.duty_u16(0)
        self.forw_motor_control_1.duty_u16(0)
        self.forw_motor_control_2.duty_u16(0)
    ...
    def back(self):
        print('Move back')
        self.right_motor_control_1.duty_u16(0)
        self.right_motor_control_2.duty_u16(self.speed_r)
        self.left_motor_control_1.duty_u16(0)
        self.left_motor_control_2.duty_u16(self.speed_l)
        self.forw_motor_control_1.duty_u16(0)
        self.forw_motor_control_2.duty_u16(0)
    ...
    def turnLeft(self):
        ...
        self.left_motor_control_1.duty_u16(self.speed_l)
        self.left_motor_control_2.duty_u16(0)
        self.forw_motor_control_1.duty_u16(self.speed_f)
        self.forw_motor_control_2.duty_u16(0)
    ...
    def turnRight(self):
        ...
        self.left_motor_control_2.duty_u16(self.speed_l)
        self.forw_motor_control_1.duty_u16(0)
        self.forw_motor_control_2.duty_u16(self.speed_f)
        
    def set_speed(self, new_speed):
        self.speed_r = new_speed[0]
        self.speed_l = new_speed[1]
        self.speed_f = new_speed[2]
